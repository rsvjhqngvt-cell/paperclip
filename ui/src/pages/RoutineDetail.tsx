    ...
    <div className="rounded-lg border border-border p-4 space-y-4">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <div className="space-y-1.5">
          <Label className="text-xs">{t("routines.triggerLabel")}</Label>
          <Input
            value={draft.label}
...
export function RoutineDetail() {
  ...
  const saveRoutine = useMutation({
    ...
    onError: (error) => {
      pushToast({
        title: t("routineDetail.failedToSave"),
        body: error instanceof Error ? error.message : t("routineDetail.couldNotSave"),
        tone: "error",
      });
    },
  });
  ...
  const runRoutine = useMutation({
    ...
    onError: (error) => {
      pushToast({
        title: t("routines.failedToRun"),
        body: error instanceof Error ? error.message : t("routines.failedToRunDesc"),
        tone: "error",
      });
    },
  });
  ...
  const updateRoutineStatus = useMutation({
    ...
    onError: (error) => {
      pushToast({
        ...
        body: error instanceof Error ? error.message : t("routines.failedToUpdateDesc"),
        tone: "error",
      });
    },
  });
  ...
  const createTrigger = useMutation({
    ...
    onError: (error) => {
      pushToast({
        title: t("routineDetail.failedToAddTrigger"),
        body: error instanceof Error ? error.message : t("routineDetail.couldNotCreateTrigger"),
        tone: "error",
      });
    },
  });
  ...
  const updateTrigger = useMutation({
    ...
    onError: (error) => {
      pushToast({
        title: t("routineDetail.failedToUpdateTrigger"),
        body: error instanceof Error ? error.message : t("routineDetail.couldNotUpdateTrigger"),
        tone: "error",
      });
    },
  });
  ...
  const deleteTrigger = useMutation({
    ...
    onError: (error) => {
      pushToast({
        title: t("routineDetail.failedToDeleteTrigger"),
        body: error instanceof Error ? error.message : t("routineDetail.couldNotDeleteTrigger"),
        tone: "error",
      });
    },
  });
  ...
  const rotateTrigger = useMutation({
    ...
    onError: (error) => {
      pushToast({
        title: t("routineDetail.failedToRotateSecret"),
        body: error instanceof Error ? error.message : t("routineDetail.couldNotRotateSecret"),
        tone: "error",
      });
    },
  });
  ...
  const automationLabel = routine.status === "archived" ? t("common.archived") : automationEnabled ? t("common.active") : t("common.paused");
